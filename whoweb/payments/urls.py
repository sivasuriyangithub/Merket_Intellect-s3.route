...
router.register(
    r"billing_seats", BillingAccountMemberViewSet, basename="billingaccountmember"
)
router.register(
    r"account_members", BillingAccountMemberViewSet, basename="dep_billingaccountmember"
)
